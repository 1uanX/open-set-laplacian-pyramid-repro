...
MODEL_CHOICES = {"moment_head", "moment_lora_rank8"}
...
def build_model(
    *,
    ...
    if model_name == "moment_lora_rank8":
...
def evaluate_all(
    ...
    *,
    ...
    for score_name in ["confidence", "centroid", "mahalanobis"]:
        metrics.update(
            score_metrics(
...
def train_one(
    *,
    ...
    lr = config.lr_lora if model_name == "moment_lora_rank8" else config.lr_head
